...
*   **Latitude:** `(Fill in later)`
*   **Longitude:** `(Fill in later)`
*   **Allowed Radius:** `(Fill in later)`
...
*   Haddii `Masaafada <= 500m`: Ogolow inuu Item-ka soo dhigo.
*   Haddii `Masaafada > 500m`: Tus fariin ah "Ma joogtid campus-ka".
...
---
*Dukumentigan waa qorshaha bilowga ah ee hirgelinta Location-based restriction.*
