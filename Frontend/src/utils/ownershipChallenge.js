...
/** ≥85 Approved · 50–80 Physical · &lt;50 Rejected (81–84 stay Physical). */
...
/** Any Ask answered → Physical only. Direct/MCQ alone → auto score bands. */
...
export function challengeResultLabel(result) {
  switch (result) {
    ...
    case 'reject':
      return 'Rejected — item is live on the board again';
    default:
